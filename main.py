...
# Streamlit App
st.title("ParkinSense")
st.sidebar.subheader("Parkinson's Disease")
st.sidebar.image('old-1015484_1920.jpg')
st.sidebar.markdown("""
Parkinson's disease (PD) is a brain dysfunction condition that affects thousands of people across the globe. 
Early detection of Parkinson's disease is crucial for effective treatment and control of symptoms.
This study employs a multi-modal methodology coded as ParkinSense that combines spiral drawings, gait analysis, and Magnetic Resonance Imaging (MRI) analysis for timely Parkinson's disease identification. 
MRI analysis provides insight into structural and functional changes in the brain, revealing potential anomalies.
GAIT analysis assesses alterations in walking patterns, such as reduced arm swing and slow gait velocity. 
Spiral drawings, serve as a surrogate for motor dexterity and fine motor control, both of which are compromised in Parkinson's disease.
\n\n
While Parkinson's throws punches, treatment can be your champion, managing symptoms and empowering you to fight back.
""")
